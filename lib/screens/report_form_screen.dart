  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      final report = FieldReport(
        ...
        trainingCentre: () {
          final hubValue = _selectedHub == 'Other' ? 'Other' : _effectiveHub;
          final otherHubName = _selectedHub == 'Other' ? _otherHubController.text.trim() : null;
          debugPrint('FORM: selectedHub=$_selectedHub, hubValue=$hubValue, otherHubName=$otherHubName');
